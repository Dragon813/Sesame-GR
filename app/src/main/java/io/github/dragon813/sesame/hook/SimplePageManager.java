...
public class SimplePageManager {
    ...
    public interface ActivityFocusHandler {
        boolean handleActivity(Activity activity, io.github.dragon813.sesame.hook.SimpleViewImage root);
    }
    ...
    public static io.github.dragon813.sesame.hook.SimpleViewImage tryGetTopView(String xpath) {
        // 清理空引用
        ...
        for (WeakReference<Dialog> dialogWeakReference : dialogs) {
            ...
            io.github.dragon813.sesame.hook.SimpleViewImage viewImage = new io.github.dragon813.sesame.hook.SimpleViewImage(decorView);
            ArrayList<io.github.dragon813.sesame.hook.SimpleViewImage> results = (ArrayList<SimpleViewImage>) SimpleXpathParser.evaluate(viewImage, xpath);
            if (!results.isEmpty()) {
