...
public class SimpleViewImage {
    ...
    public SimpleViewImage xpath2One(String xpath) {
        List<SimpleViewImage> results = io.github.dragon813.sesame.hook.SimpleXpathParser.evaluate(this, xpath);
        if (!results.isEmpty()) {
            return results.get(0);
        }
        return io.github.dragon813.sesame.hook.SimplePageManager.tryGetTopView(xpath);
    }
