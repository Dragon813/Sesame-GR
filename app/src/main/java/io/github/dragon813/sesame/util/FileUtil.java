package io.github.dragon813.sesame.util;

import static io.github.dragon813.sesame.util.idMap.UserIdMap.getShowName;
...
public class FileUtil {
    ...
    //路径
    public static final String CONFIG_DIRECTORY_NAME = "sesame-GR";
