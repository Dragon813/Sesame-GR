...
public class AntSportsRpcCall {
  private static final String chInfo = "ch_appcenter__chsub_9patch",
      ...
      version = "3.0.1.2",
      alipayAppVersion = "0.0.852",
      cityCode = "330100",
      appId = "2021002116659397";
  ...
  public static String queryCoinTaskPanel() {
    ...
    return ApplicationHook.requestString(
        "com.alipay.sportshealth.biz.rpc.SportsHealthCoinTaskRpc.queryCoinTaskPanel", args);
  }

  public static String signUpTask(String taskId) {
    String args = "[{\"taskId\":\"" + taskId + "\"}]";
    return ApplicationHook.requestString(
        "com.alipay.sportshealth.biz.rpc.SportsHealthCoinTaskRpc.signUpTask", args);
  }
  ...
  public static String completeTask(String taskAction, String taskId) {
    ...
    return ApplicationHook.requestString(
        "com.alipay.sportshealth.biz.rpc.SportsHealthCoinTaskRpc.completeTask", args);
  }

  public static String duublecompleteTask(String bizNo, String taskAction, String taskId) {
    String args =
        "[{\"apiVersion\":\"energy\",\"bizNo\":\""
            + bizNo
            + "\",\"taskAction\":\""
            + taskAction
            + "\",\"taskId\":\""
  ...
  public static String signInCoinTask() {
    ...
    return ApplicationHook.requestString(
        "com.alipay.sportshealth.biz.rpc.SportsHealthCoinTaskRpc.signInCoinTask", args);
  }
  ...
  public static String queryCoinBubbleModule() {
    String args =
        "[{\"apiVersion\":\"energy\",\"bubbleId\":\"\",\"canAddHome\":false,\"chInfo\":\"ch_shouquan_shouye\",\"clientAuthStatus\":\"not_support\",\"clientOS\":\"android\",\"distributionChannel\":\"\",\"features\":[\"DAILY_STEPS_RANK_V2\",\"STEP_BATTLE\",\"CLUB_HOME_CARD\",\"NEW_HOME_PAGE_STATIC\",\"CLOUD_SDK_AUTH\",\"STAY_ON_COMPLETE\",\"EXTRA_TREASURE_BOX\",\"NEW_HOME_PAGE_STATIC\",\"SUPPORT_AI\",\"SUPPORT_TAB3\",\"SUPPORT_FLYRABBIT\",\"SUPPORT_NEW_MATCH\",\"EXTERNAL_ADVERTISEMENT_TASK\",\"PROP\",\"PROPV2\",\"ASIAN_GAMES\"],\"outBizNo\":\"\"}]";
    return ApplicationHook.requestString(
        "com.alipay.sportshealth.biz.rpc.sportsHealthHomeRpc.queryEnergyBubbleModule", args);
  }
  ...
  */
  public static String receiveCoinAsset(String assetId) {
    ...
    String args =
        "[{\"apiVersion\":\"energy\",\"chInfo\":\"medical_health\",\"clientOS\":\"android\",\"features\":[\"DAILY_STEPS_RANK_V2\",\"STEP_BATTLE\",\"CLUB_HOME_CARD\",\"NEW_HOME_PAGE_STATIC\",\"CLOUD_SDK_AUTH\",\"STAY_ON_COMPLETE\",\"EXTRA_TREASURE_BOX\",\"NEW_HOME_PAGE_STATIC\",\"SUPPORT_AI\",\"SUPPORT_TAB3\",\"SUPPORT_FLYRABBIT\",\"SUPPORT_NEW_MATCH\",\"EXTERNAL_ADVERTISEMENT_TASK\",\"PROP\",\"PROPV2\",\"ASIAN_GAMES\"],\"medEnergyBallInfoRecordIds\":[\""
            + assetId
  ...
  public static String donate(int donateCharityCoin, String projectId) {
    String args =
        "[{\"donateCharityCoin\":" + donateCharityCoin + ",\"projectId\":\"" + projectId + "\"}]";
  ...
  public static String walkDonateSignInfo(int count) {
    return ApplicationHook.requestString(
        ...
        "[{\"needDonateAction\":false,\"source\":\"walkDonateHome\",\"steps\":"
            + count
            + ",\"timezoneId\":\""
            + timeZone
            + "\"}]");
  ...
  public static String donateWalkHome(int steps) {
    String args =
        "[{\"module\":\"3\",\"steps\":" + steps + ",\"timezoneId\":\"" + timeZone + "\"}]";
  ...
  public static String queryPathReward(String pathId) {
    String args = "[{\"pathId\":\"" + pathId + "\"}]";
    return ApplicationHook.requestString(
        "com.alipay.sportsplay.biz.rpc.walk.queryPathReward", args);
  }
  ...
  public static String queryAccount() {
    return ApplicationHook.requestString(
        "alipay.tiyubiz.user.asset.query.account", "[{\"accountType\":\"TIYU_SEED\"}]");
  }
  ...
  public static String participate(
      int bettingPoints, String InstanceId, String ResultId, String roundId) {
    return ApplicationHook.requestString(
  ...
  public static String tiyubizGo(
      String countDate, int goStepCount, String pathId, String userPathRecordId) {
    return ApplicationHook.requestString(
  ...
  public static String queryClubHome() {
    return ApplicationHook.requestString(
        ...
        "[{\"apiVersion\":\"energy\",\"chInfo\":\"healthstep\",\"timeZone\":\""
            + timeZone
            + "\"}]");
  }
  ...
  public static String queryClubRoom(String roomId) {
    String args =
        "[{\"apiVersion\":\"energy\",\"chInfo\":\"healthstep\",\"roomId\":\"" + roomId + "\"}]";
  ...
  public static String collectBubble(String bubbleId) {
    return ApplicationHook.requestString(
        ...
        "[{\"apiVersion\":\"energy\",\"medEnergyBallInfoRecordIds\":[\""
            + bubbleId
            + "\"],\"pickAllEnergyBall\":false,\"source\":\"SPORT\"}]");
  }
  ...
  public static String DoubletrainMember(
      String itemType, String bizId, String memberId, String originBossId) {
    return ApplicationHook.requestString(
        "alipay.antsports.club.train.trainMember",
        "[{\"apiVersion\":\"energy\",\"bizId\":\""
            + bizId
            + "\",\"chInfo\":\"healthstep\",\"itemType\":\""
            + itemType
            + "\",\"memberId\":\""
            + memberId
            + "\",\"originBossId\":\""
  ...
  public static String trainMember(String itemType, String memberId, String originBossId) {
    return ApplicationHook.requestString(
        "alipay.antsports.club.train.trainMember",
        "[{\"apiVersion\":\"energy\",\"chInfo\":\"healthstep\",\"itemType\":\""
            + itemType
            + "\",\"memberId\":\""
            + memberId
            + "\",\"originBossId\":\""
  ...
  public static String completeTask(String bizId) {
    return ApplicationHook.requestString(
        ...
        "[{\"apiVersion\":\"energy\",\"bizNo\":\""
            + bizId
            + "\",\"taskAction\":\"SHOW_AD\",\"taskId\":\"AP16235854\",\"taskType\":\"AD_TASK\"}]");
  }

  public static String queryMemberPriceRankingEnergy(int coinBalance) {
    String args =
        "[{\"apiVersion\":\"energy\",\"buyMember\":true,\"chInfo\":\"healthstep\",\"coinBalance\":\""
            + coinBalance
            + "\"}]";
    return ApplicationHook.requestString(
        "alipay.antsports.club.ranking.queryMemberPriceRanking", args);
  }
  ...
  public static String queryClubMember(String memberId, String originBossId) {
    return ApplicationHook.requestString(
        "alipay.antsports.club.trade.queryClubMember",
        "[{\"apiVersion\":\"energy\",\"chInfo\":\"healthstep\",\"memberId\":\""
            + memberId
            + "\",\"originBossId\":\""
            + originBossId
            + "\"}]");
  ...
  public static String buyMember(
      ...
      String roomId) {
    String requestData =
        "[{\"apiVersion\":\"energy\",\"chInfo\":\"healthstep\",\"currentBossId\":\""
            + currentBossId
            + "\",\"memberId\":\""
            + memberId
            + "\",\"originBossId\":\""
  ...
  public static String queryItemDetail(String itemId) {
    ...
    return ApplicationHook.requestString(
        "com.alipay.sportshealth.biz.rpc.SportsHealthItemCenterRpc.queryItemDetail", arg);
  }

  public static String exchangeItem(String itemId, int coinAmount) {
    String arg = "[{\"coinAmount\":" + coinAmount + ",\"itemId\":\"" + itemId + "\"}]";
    return ApplicationHook.requestString(
        "com.alipay.sportshealth.biz.rpc.SportsHealthItemCenterRpc.exchangeItem", arg);
  }

  public static String queryExchangeRecordPage(String exchangeRecordId) {
    String arg = "[{\"exchangeRecordId\":\"" + exchangeRecordId + "\"}]";
    return ApplicationHook.requestString(
        "com.alipay.sportshealth.biz.rpc.SportsHealthItemCenterRpc.queryExchangeRecordPage", arg);
  }
}
