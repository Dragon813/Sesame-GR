...
public class AntSportsRpcCall {
    private static final String chInfo = "ch_appcenter__chsub_9patch", timeZone = "Asia/Shanghai", version =
            "3.0.1" + ".2", alipayAppVersion = "0.0.852", cityCode = "330100", appId = "2021002116659397";
    ...
    public static String queryCoinTaskPanel() {
        String args = "[{\"apiVersion\":\"energy\",\"canAddHome\":false,\"chInfo\":\"medical_health\"," +
                ...
                + "\"STEP_BATTLE\",\"CLUB_HOME_CARD\",\"NEW_HOME_PAGE_STATIC\",\"CLOUD_SDK_AUTH\"," +
                "\"STAY_ON_COMPLETE\"," + "\"EXTRA_TREASURE_BOX\",\"NEW_HOME_PAGE_STATIC\",\"SUPPORT_AI\"," +
                "\"SUPPORT_TAB3\"," + "\"SUPPORT_FLYRABBIT\",\"SUPPORT_NEW_MATCH\",\"EXTERNAL_ADVERTISEMENT_TASK\"," + "\"PROP\",\"PROPV2\"," + "\"ASIAN_GAMES\"],\"topTaskId\":\"\"}]";
        return ApplicationHook.requestString("com.alipay.sportshealth.biz.rpc.SportsHealthCoinTaskRpc" +
                ".queryCoinTaskPanel", args);
    }

    public static String signUpTask(String taskId) {
        String args = "[{\"taskId\":\"" + taskId + "\"}]";
        return ApplicationHook.requestString("com.alipay.sportshealth.biz.rpc.SportsHealthCoinTaskRpc.signUpTask",
                args);
    }
    ...
    public static String duublecompleteTask(String bizNo, String taskAction, String taskId) {
        String args = "[{\"apiVersion\":\"energy\",\"bizNo\":\"" + bizNo + "\",\"taskAction\":\"" + taskAction + "\","
                + "\"taskId\":\"" + taskId + "\",\"taskType\":\"AD_TASK\"}]";
        return ApplicationHook.requestString("com.alipay.sportshealth.biz.rpc.SportsHealthCoinTaskRpc.completeTask",
                args);
    }
    ...
    public static String queryCoinBubbleModule() {
        String args = "[{\"apiVersion\":\"energy\",\"bubbleId\":\"\",\"canAddHome\":false," + "\"chInfo" +
                "\":\"ch_shouquan_shouye\",\"clientAuthStatus\":\"not_support\",\"clientOS\":\"android\"," +
                "\"distributionChannel\":\"\",\"features\":[\"DAILY_STEPS_RANK_V2\",\"STEP_BATTLE\"," +
                "\"CLUB_HOME_CARD\",\"NEW_HOME_PAGE_STATIC\",\"CLOUD_SDK_AUTH\",\"STAY_ON_COMPLETE\"," +
                "\"EXTRA_TREASURE_BOX\",\"NEW_HOME_PAGE_STATIC\",\"SUPPORT_AI\",\"SUPPORT_TAB3\"," +
                "\"SUPPORT_FLYRABBIT\",\"SUPPORT_NEW_MATCH\",\"EXTERNAL_ADVERTISEMENT_TASK\",\"PROP\",\"PROPV2\"," +
                "\"ASIAN_GAMES\"],\"outBizNo\":\"\"}]";
        return ApplicationHook.requestString("com.alipay.sportshealth.biz.rpc.sportsHealthHomeRpc" +
                ".queryEnergyBubbleModule", args);
    }
    ...
    */
    public static String receiveCoinAsset(String assetId) {
        ...
        String args = "[{\"apiVersion\":\"energy\",\"chInfo\":\"medical_health\",\"clientOS\":\"android\"," +
    ...
    public static String pickAllEnergyBall() {
        String args = "[{\"apiVersion\":\"energy\",\"chInfo\":\"ch_shouquan_shouye\",\"clientOS\":\"android\"," +
    ...
    public static String queryWalkStep() {
        String args = "[{}]"; return ApplicationHook.requestString("alipay.antsports.walk.user.queryWalkStep", args);
    }
    ...
    public static String walkDonateSignInfo(int count) {
        return ApplicationHook.requestString("alipay.charity.mobile.donate.walk.walkDonateSignInfo",
                "[{\"needDonateAction\":false,\"source\":\"walkDonateHome\",\"steps\":" + count + ",\"timezoneId" +
                        "\":\"" + timeZone + "\"}]");
    }
    ...
    public static String donateWalkExchange(String actId, int count, String donateToken) {
        return ApplicationHook.requestString("alipay.charity.mobile.donate.walk.exchange",
                "[{\"actId\":\"" + actId + "\",\"count\":" + count + ",\"donateToken\":\"" + donateToken + "\"," +
                        "\"timezoneId\":\"" + timeZone + "\",\"ver\":0}]");
    }
    ...
    public static String queryPathName(String pathId) {
        try {
            ...
            if (MessageUtil.checkSuccess("queryPathName", jo)) {
                jo = jo.getJSONObject("data").getJSONObject("path"); return jo.getString("name");
            }
        } catch (Throwable t) {
    ...
    public static String walkGo(String date, String pathId, int useStepCount) {
        String args =
                "[{\"date\":\"" + date + "\",\"pathId\":\"" + pathId + "\",\"useStepCount\":\"" + useStepCount + "\"}]";
    ...
    public static String receiveEvent(String eventBillNo) {
        return ApplicationHook.requestString("com.alipay.sportsplay.biz.rpc.walk.receiveEvent", "[{\"eventBillNo" +
                "\":\"" + eventBillNo + "\"}]");
    }
    ...
    public static String userTaskComplete(String bizType, String taskId) {
        return ApplicationHook.requestString("alipay.tiyubiz.sports.userTask.complete",
                "[{\"bizType\":\"" + bizType + "\",\"cityCode\":\"" + cityCode + "\",\"completedTime\":" + System.currentTimeMillis() + ",\"taskId\":\"" + taskId + "\"}]");
    }
    ...
    public static String queryAccount() {
        return ApplicationHook.requestString("alipay.tiyubiz.user.asset.query.account", "[{\"accountType" +
                "\":\"TIYU_SEED\"}]");
    }
    ...
    public static String participate(int bettingPoints, String InstanceId, String ResultId, String roundId) {
        return ApplicationHook.requestString("alipay.tiyubiz.wenti.walk.participate",
                "[{\"bettingPoints\":" + bettingPoints + ",\"guessInstanceId\":\"" + InstanceId + "\",\"guessResultId"
                        + "\":\"" + ResultId + "\",\"newParticipant\":false,\"roundId\":\"" + roundId + "\"," +
                        "\"stepTimeZone\":\"" + timeZone + "\"}]");
    }

    public static String pathFeatureQuery() {
        return ApplicationHook.requestString("alipay.tiyubiz.path.feature.query", "[{\"appId\":\"" + appId + "\"," +
    ...
    public static String pathMapHomepage(String pathId) {
        return ApplicationHook.requestString("alipay.tiyubiz.path.map.homepage", "[{\"appId\":\"" + appId + "\"," +
                "\"pathId\":\"" + pathId + "\"}]");
    }
    ...
    public static String stepQuery(String countDate, String pathId) {
        return ApplicationHook.requestString("alipay.tiyubiz.path.map.step.query",
                "[{\"appId\":\"" + appId + "\"," + "\"countDate\":\"" + countDate + "\",\"pathId\":\"" + pathId +
                        "\",\"timeZone\":\"" + timeZone + "\"}]");
    }

    public static String tiyubizGo(String countDate, int goStepCount, String pathId, String userPathRecordId) {
        return ApplicationHook.requestString("alipay.tiyubiz.path.map.go", "[{\"appId\":\"" + appId + "\",\"countDate"
                + "\":\"" + countDate + "\",\"goStepCount\":" + goStepCount + ",\"pathId\":\"" + pathId + "\"," +
                "\"timeZone\":\"" + timeZone + "\",\"userPathRecordId\":\"" + userPathRecordId + "\"}]");
    }

    public static String rewardReceive(String pathId, String userPathRewardId) {
        return ApplicationHook.requestString("alipay.tiyubiz.path.map.reward.receive", "[{\"appId\":\"" + appId +
                "\",\"pathId\":\"" + pathId + "\",\"userPathRewardId\":\"" + userPathRewardId + "\"}]");
    }
    ...
    public static String collectBubble(String bubbleId) {
        return ApplicationHook.requestString("com.alipay.neverland.biz.rpc.pickBubbleTaskEnergy", "[{\"apiVersion" +
                "\":\"energy\",\"medEnergyBallInfoRecordIds\":[\"" + bubbleId + "\"],\"pickAllEnergyBall\":false," +
                "\"source\":\"SPORT\"}]");
    }

    // [{"apiVersion":"energy","chInfo":"healthstep"}]
    public static String queryTrainItem() {
        return ApplicationHook.requestString("alipay.antsports.club.train.queryTrainItem", "[{\"apiVersion\":\"energy"
                + "\",\"chInfo\":\"healthstep\"}]");
    }
    ...
    public static String DoubletrainMember(String itemType, String bizId, String memberId, String originBossId) {
        return ApplicationHook.requestString("alipay.antsports.club.train.trainMember", "[{\"apiVersion\":\"energy\","
                + "\"bizId\":\"" + bizId + "\",\"chInfo\":\"healthstep\",\"itemType\":\"" + itemType + "\",\"memberId"
                + "\":\"" + memberId + "\",\"originBossId\":\"" + originBossId + "\"}]");
    }

    public static String trainMember(String itemType, String memberId, String originBossId) {
        return ApplicationHook.requestString("alipay.antsports.club.train.trainMember", "[{\"apiVersion\":\"energy\","
                + "\"chInfo\":\"healthstep\",\"itemType\":\"" + itemType + "\",\"memberId\":\"" + memberId + "\"," +
    ...
    public static String completeTask(String bizId) {
        return ApplicationHook.requestString("alipay.antsports.club.train.trainMember", "[{\"apiVersion\":\"energy\","
                + "\"bizNo\":\"" + bizId + "\",\"taskAction\":\"SHOW_AD\",\"taskId\":\"AP16235854\"," + "\"taskType" + "\":\"AD_TASK\"}]");
    }

    public static String queryMemberPriceRankingEnergy(int coinBalance) {
        String args =
                "[{\"apiVersion\":\"energy\",\"buyMember\":true,\"chInfo\":\"healthstep\",\"coinBalance\":\"" + coinBalance + "\"}]";
    ...
    public static String queryClubMember(String memberId, String originBossId) {
        return ApplicationHook.requestString("alipay.antsports.club.trade.queryClubMember", "[{\"apiVersion" +
                "\":\"energy\",\"chInfo\":\"healthstep\",\"memberId\":\"" + memberId + "\",\"originBossId\":\"" + originBossId + "\"}]");
    }

    public static String buyMember(String currentBossId, String memberId, String originBossId, JSONObject priceInfo,
                                   String roomId) {
        String requestData =
                "[{\"apiVersion\":\"energy\",\"chInfo\":\"healthstep\",\"currentBossId\":\"" + currentBossId + "\"," + "\"memberId\":\"" + memberId + "\",\"originBossId\":\"" + originBossId + "\",\"priceInfo\":" + priceInfo + ",\"roomId\":\"" + roomId + "\"}]";
    ...
    public static String queryItemDetail(String itemId) {
        ...
        return ApplicationHook.requestString("com.alipay.sportshealth.biz.rpc.SportsHealthItemCenterRpc" +
                ".queryItemDetail", arg);
    }

    public static String exchangeItem(String itemId, int coinAmount) {
        String arg = "[{\"coinAmount\":" + coinAmount + ",\"itemId\":\"" + itemId + "\"}]";
        return ApplicationHook.requestString("com.alipay.sportshealth.biz.rpc.SportsHealthItemCenterRpc.exchangeItem"
                , arg);
    }
