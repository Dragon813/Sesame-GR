...
public class AntForestRpcCall {
    ...
    public static String queryEnergyRanking() {
        return ApplicationHook.requestString("alipay.antmember.forest.h5.queryEnergyRanking", "[{\"periodType" +
                "\":\"total\",\"rankType\":\"energyRank\",\"source\":\"chInfo_ch_appcenter__chsub_9patch\"," +
                "\"version\":\"" + VERSION + "\"}]", "{\"pathList\":[\"friendRanking\",\"myself\",\"totalDatas\"]}");
    }
    ...
    public static String queryHomePage() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.queryHomePage", "[{\"configVersionMap" +
                "\":{\"wateringBubbleConfig\":\"10\"},\"skipWhackMole\":true," + "\"source" +
                "\":\"chInfo_ch_appcenter__chsub_9patch\",\"version\":\"" + VERSION + "\"}]", 3, 1000);
    }

    public static String queryDynamicsIndex() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.queryDynamicsIndex", "[{\"autoRefresh" +
    ...
    public static String queryFriendHomePage(String userId) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.queryFriendHomePage", "[{\"canRobFlags" +
                ...
                "\"source\":\"chInfo_ch_appcenter__chsub_9patch\",\"userId\":\"" + userId + "\",\"version\":\"" + VERSION + "\"}]", 3, 1000);
    }

    public static RpcEntity getCollectEnergyRpcEntity(String bizType, String userId, long bubbleId) {
        String args1; if (StringUtil.isEmpty(bizType)) {
            args1 = "[{\"bizType\":\"\",\"bubbleIds\":[" + bubbleId + "],\"source" +
                    "\":\"chInfo_ch_appcenter__chsub_9patch\",\"userId\":\"" + userId + "\",\"version\":\"" + VERSION + "\"}]";
        } else {
            args1 = "[{\"bizType\":\"" + bizType + "\",\"bubbleIds\":[" + bubbleId + "],\"source" +
                    "\":\"chInfo_ch_appcenter__chsub_9patch\",\"userId\":\"" + userId + "\"}]";
    ...
    public static RpcEntity getCollectBatchEnergyRpcEntity(String userId, String bubbleIds) {
        return new RpcEntity("alipay.antmember.forest.h5.collectEnergy",
                "[{\"bizType\":\"\",\"bubbleIds\":[" + bubbleIds + "],\"fromAct\":\"BATCH_ROB_ENERGY\"," + "\"source" +
                        "\":\"chInfo_ch_appcenter__chsub_9patch\",\"userId\":\"" + userId + "\",\"version" + "\":\"" + VERSION + "\"}]");
    }
    ...
    public static String collectRebornEnergy() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.collectRebornEnergy", "[{\"source" +
                "\":\"chInfo_ch_appcenter__chsub_9patch\"}]");
    }

    public static String transferEnergy(String targetUser, String bizNo, int energyId) {
        return ApplicationHook.requestString("alipay.antmember.forest.h5.transferEnergy",
                "[{\"bizNo\":\"" + bizNo + UUID.randomUUID().toString() + "\",\"energyId\":" + energyId + ",\"extInfo"
                        + "\":{\"sendChat\":\"N\"},\"from\":\"friendIndex\"," + "\"source" +
                        "\":\"chInfo_ch_appcenter__chsub_9patch\",\"targetUser\":\"" + targetUser + "\"," +
                        "\"transferType\":\"WATERING\",\"version\":\"" + VERSION + "\"}]");
    }
    ...
    public static String vitalitySign() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.vitalitySign", "[{\"source" +
                "\":\"chInfo_ch_appcenter__chsub_9patch\"}]");
    }


    public static String antiepSign(String entityId, String userId, String sceneCode) {
        String args = "[{\"entityId\":\"" + entityId + "\",\"requestType\":\"rpc\",\"sceneCode\":\"" + sceneCode +
                "\",\"source\":\"ANTFOREST\",\"userId\":\"" + userId + "\"}]";
    ...
    public static String queryTaskList(JSONObject extend) {
        String args = "[{\"extend\":" + extend + ",\"fromAct\":\"home_task_list\"," + "\"source" +
    ...
    public static String energyRainSettlement(int saveEnergy, String token) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.energyRainSettlement", "[{\"activityPropNums"
                + "\":0,\"saveEnergy\":" + saveEnergy + ",\"token\":\"" + token + "\",\"version\":\"" + VERSION +
                "\"}]");
    }

    public static String receiveTaskAward(String sceneCode, String taskType) {
        return ApplicationHook.requestString("com.alipay.antiep.receiveTaskAward", "[{\"ignoreLimit\":false," +
                "\"requestType\":\"H5\",\"sceneCode\":\"" + sceneCode + "\",\"source\":\"ANTFOREST\",\"taskType\":\"" + taskType + "\"}]");
    }
    ...
    public static String finishTask(String sceneCode, String taskType) {
        ...
        return ApplicationHook.requestString("com.alipay.antiep.finishTask",
                "[{\"outBizNo\":\"" + outBizNo + "\"," + "\"requestType\":\"H5\",\"sceneCode\":\"" + sceneCode + "\"," +
                        "\"source\":\"ANTFOREST\",\"taskType\":\"" + taskType + "\"}]");
    }

    public static String popupTask() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.popupTask", "[{\"fromAct\":\"pop_task\"," +
                "\"needInitSign\":false,\"source\":\"chInfo_ch_appcenter__chsub_9patch\",\"statusList\":[\"TODO\"," + "\"FINISHED\"],\"version\":\"" + VERSION + "\"}]");
    }
...
*/
    public static String queryPropList(boolean onlyGive) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.queryPropList",
                "[{\"onlyGive\":\"" + (onlyGive ? "Y" : "") + "\",\"source\":\"chInfo_ch_appcenter__chsub_9patch\"," + "\"version\":\"" + VERSION + "\"}]");
    }

    // 查询可派遣伙伴
    public static String queryAnimalPropList() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.queryAnimalPropList", "[{\"source" +
                "\":\"chInfo_ch_appcenter__chsub_9patch\"}]");
    }
    ...
    public static String consumeProp(String propGroup, String propType, Boolean replace) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.consumeProp",
                "[{\"propGroup\":\"" + propGroup + "\",\"propType\":\"" + propType + "\",\"replace\":\"" + (replace ?
                        "true" : "false") + "\",\"sToken\":\"" + System.currentTimeMillis() + "_" + RandomUtil.getRandomString(8) + "\",\"source\":\"chInfo_ch_appcenter__chsub_9patch\"}]");
    }
    ...
    public static String giveProp(String giveConfigId, String propId, String targetUserId) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.giveProp",
                "[{\"giveConfigId\":\"" + giveConfigId + "\",\"propId\":\"" + propId + "\",\"source\":\"self_corner" + "\",\"targetUserId\":\"" + targetUserId + "\"}]");
    }
    ...
    public static String collectProp(String giveConfigId, String giveId) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.collectProp",
                "[{\"giveConfigId\":\"" + giveConfigId + "\",\"giveId\":\"" + giveId + "\",\"source" +
                        "\":\"chInfo_ch_appcenter__chsub_9patch\"}]");
    }

    public static String consumeProp(String propId, String propType) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.consumeProp", "[{\"propId\":\"" + propId +
                "\",\"propType\":\"" + propType + "\",\"source\":\"chInfo_ch_appcenter__chsub_9patch\"," +
                "\"timezoneId\":\"Asia/Shanghai\",\"version\":\"" + VERSION + "\"}]");
    }

    public static String itemList(String labelType) {
        return ApplicationHook.requestString("com.alipay.antiep.itemList",
                "[{\"extendInfo\":\"{}\",\"labelType\":\"" + labelType + "\",\"pageSize\":20,\"requestType\":\"rpc\","
                        + "\"sceneCode\":\"ANTFOREST_VITALITY\",\"source\":\"afEntry\",\"startIndex\":0}]");
    }

    public static String itemDetail(String spuId) {
        return ApplicationHook.requestString("com.alipay.antiep.itemDetail", "[{\"requestType\":\"rpc\"," +
                "\"sceneCode\":\"ANTFOREST_VITALITY\",\"source\":\"afEntry\",\"spuId\":\"" + spuId + "\"}]");
    }

    public static String queryVitalityStoreIndex() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.queryVitalityStoreIndex", "[{\"source" +
                "\":\"afEntry\"}]");
    }
    ...
    public static String queryUserPatrol() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.queryUserPatrol", "[{\"source\":\"ant_forest"
                + "\",\"timezoneId\":\"Asia/Shanghai\"}]");
    }

    public static String queryMyPatrolRecord() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.queryMyPatrolRecord", "[{\"source" +
                "\":\"ant_forest\",\"timezoneId\":\"Asia/Shanghai\"}]");
    }

    public static String switchUserPatrol(String targetPatrolId) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.switchUserPatrol", "[{\"source" +
                "\":\"ant_forest\",\"targetPatrolId\":" + targetPatrolId + ",\"timezoneId\":\"Asia/Shanghai\"}]");
    }

    public static String patrolGo(int nodeIndex, int patrolId) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.patrolGo", "[{\"nodeIndex\":" + nodeIndex +
                ",\"patrolId\":" + patrolId + ",\"source\":\"ant_forest\",\"timezoneId\":\"Asia/Shanghai\"}]");
    }

    public static String patrolKeepGoing(int nodeIndex, int patrolId, String eventType) {
        String args = null; switch (eventType) {
            case "video":
                args = "[{\"nodeIndex\":" + nodeIndex + ",\"patrolId\":" + patrolId + ",\"reactParam\":{\"viewed" +
                        "\":\"Y\"},\"source\":\"ant_forest\",\"timezoneId\":\"Asia/Shanghai\"}]"; break;
            case "chase":
                args = "[{\"nodeIndex\":" + nodeIndex + ",\"patrolId\":" + patrolId + ",\"reactParam\":{\"sendChat" + "\":\"Y\"},\"source\":\"ant_forest\",\"timezoneId\":\"Asia/Shanghai\"}]"; break;
            case "quiz":
                args = "[{\"nodeIndex\":" + nodeIndex + ",\"patrolId\":" + patrolId + ",\"reactParam\":{\"answer" +
                        "\":\"correct\"},\"source\":\"ant_forest\",\"timezoneId\":\"Asia/Shanghai\"}]"; break;
            default:
                args = "[{\"nodeIndex\":" + nodeIndex + ",\"patrolId\":" + patrolId + ",\"reactParam\":{}," +
                        "\"source\":\"ant_forest\",\"timezoneId\":\"Asia/Shanghai\"}]"; break;
    ...
    public static String queryAnimalAndPiece(int animalId) {
        String args = null; if (animalId != 0) {
            args = "[{\"animalId\":" + animalId + ",\"source\":\"ant_forest\",\"timezoneId\":\"Asia/Shanghai\"}]";
        } else {
            args = "[{\"source\":\"ant_forest\",\"timezoneId\":\"Asia/Shanghai\",\"withDetail\":\"N\"," + "\"withGift" +
                    "\":true}]";
    ...
    public static String combineAnimalPiece(int animalId, String piecePropIds) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.combineAnimalPiece",
                "[{\"animalId\":" + animalId + ",\"piecePropIds\":" + piecePropIds + ",\"timezoneId\":\"Asia/Shanghai"
                        + "\",\"source\":\"ant_forest\"}]");
    }
    ...
    public static String protectBubble(String targetUserId) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.protectBubble", "[{\"source" +
                "\":\"ANT_FOREST_H5\",\"targetUserId\":\"" + targetUserId + "\",\"version\":\"" + VERSION + "\"}]");
    }

    /* 森林礼盒 */
    public static String collectFriendGiftBox(String targetId, String targetUserId) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.collectFriendGiftBox", "[{\"source" +
                "\":\"chInfo_ch_appcenter__chsub_9patch\",\"targetId\":\"" + targetId + "\",\"targetUserId\":\"" + targetUserId + "\"}]");
    }

    /* 6秒拼手速 打地鼠 */
    public static String startWhackMole() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.startWhackMole", "[{\"source" +
                "\":\"chInfo_ch_appcenter__chsub_9patch\"}]");
    }
    ...
    public static String settlementWhackMole(String token, List<String> moleIdList) {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.settlementWhackMole",
                "[{\"moleIdList\":[" + String.join(",", moleIdList) + "],\"settlementScene\":\"NORMAL\"," + "\"source" +
                        "\":\"chInfo_ch_appcenter__chsub_9patch\",\"token\":\"" + token + "\",\"version\":\"" + VERSION + "\"}]");
    }

    public static String closeWhackMole() {
        return ApplicationHook.requestString("alipay.antforest.forest.h5.updateUserConfig", "[{\"configMap" +
                "\":{\"whackMole\":\"N\"},\"source\":\"chInfo_ch_appcenter__chsub_9patch\"}]");
    }
    ...
    public static String query_forest_energy() {
        return ApplicationHook.requestString("alipay.iblib.channel.data",
                "[{\"activityCode\":\"query_forest_energy" + "\",\"activityId\":\"2024052300762675\"," +
                        "\"appId\":\"2021003141652419\"," + "\"body\":{\"scene\":\"FEEDS\"},\"version\":\"2.0\"}]");
    }

    public static String produce_forest_energy(String uniqueId) {
        return ApplicationHook.requestString("alipay.iblib.channel.data", "[{\"activityCode\":\"produce_forest_energy"
                + "\",\"activityId\":\"2024052300762674\",\"appId\":\"2021003141652419\"," +
                "\"body\":{\"scene\":\"FEEDS\"," + "\"uniqueId\":\"" + uniqueId + "\"},\"version\":\"2.0\"}]");
    }

    public static String harvest_forest_energy(int energy, String id) {
        return ApplicationHook.requestString("alipay.iblib.channel.data", "[{\"activityCode\":\"harvest_forest_energy"
                + "\",\"activityId\":\"2024052300762676\",\"appId\":\"2021003141652419\"," + "\"body\":{\"bubbles" +
                "\":[{\"energy\":" + energy + ",\"id\":\"" + id + "\"}],\"scene\":\"FEEDS\"}," + "\"version\":\"2" +
                ".0\"}]");
    }

    // 查询森林能量
    public static String queryForestEnergy(String scene) {
        String args = "[{\"activityCode\":\"query_forest_energy\",\"activityId\":\"2024052300762675\"," + "\"body" +
                "\":{\"scene\":\"" + scene + "\"},\"version\":\"2.0\"}]";
    ...
    public static String produceForestEnergy(String scene) {
        ...
        String args = "[{\"activityCode\":\"produce_forest_energy\",\"activityId\":\"2024052300762674\"," + "\"body" +
                "\":{\"scene\":\"" + scene + "\",\"uniqueId\":\"" + uniqueId + "\"},\"version\":\"2.0\"}]";
        return ApplicationHook.requestString("alipay.iblib.channel.data", args);
    }

    // 领取森林能量
    public static String harvestForestEnergy(String scene, JSONArray bubbles) {
        String args = "[{\"activityCode\":\"harvest_forest_energy\",\"activityId\":\"2024052300762676\"," + "\"body" +
                "\":{\"bubbles\":" + bubbles + ",\"scene\":\"" + scene + "\"},\"version\":\"2.0\"}]";
        return ApplicationHook.requestString("alipay.iblib.channel.data", args);
    }

    // 森林皮肤
    public static String listUserDressForBackpack(String positionType) {
        String args = "[{\"positionType\":\"" + positionType + "\"," + "\"source" +
                "\":\"chInfo_ch_appcenter__chsub_9patch\"," + "\"version\":\"" + VERSION + "\"}]";
    ...
    public static String wearDress(String dressType) {
        String args =
                "[{\"dressType\":\"" + dressType + "\"," + "\"outBizNo\":\"" + dressType + RandomUtil.nextDouble() +
                        "\"," + "\"source\":\"chInfo_ch_appcenter__chsub_9patch\"}]";
    ...
    public static String checkUserSecondSceneChance() {
        ...
        return ApplicationHook.requestString("com.alipay.creditapollon.biz.rpc.api.rent.green" +
                ".checkUserSecondSceneChance", requestData);
    }

    public static String generateEnergy() {
        String requestData = "[{\"requestSceneCode\":\"rentBrowse\"}]";
        return ApplicationHook.requestString("com.alipay.creditapollon.biz.rpc.api.rent.green.generateEnergy",
                requestData);
    }
    ...
    public static String loveteamWater(String loveteamWater, int loveteamWaterNum) {
        String requestData = "[{\"donateNum\":" + loveteamWaterNum + ",\"source\":\"chInfo_ch_appcenter__chsub_9patch"
                + "\",\"teamId\":\"" + loveteamWater + "\"}]";
    ...
    public static String shareComponentRecall(String sceneCode, String shareId) {
        String requestData =
                "[{\"iepShareChannelType\":\"qrcode\",\"requestType\":\"RPC\",\"sceneCode\":\"" + sceneCode + "\"," + "\"shareId\":\"" + shareId + "\",\"source\":\"chouchoule\"}]";
    ...
    public static String confirmShareRecall(String activityId, String p2pSceneCode, String shareId, String userId) {
        String requestData =
                "[{\"beSharedBizExtInfo\":{\"drawActivityId\":\"" + activityId + "\",\"inviterUid\":\"" + userId +
                        "\"},\"requestType\":\"RPC\",\"sceneCode\":\"" + p2pSceneCode + "\",\"shareId\":\"" + shareId + "\",\"source\":\"chouchoule\",\"userId\":\"" + userId + "\"}]";
    ...
    public static String enterDrawActivityopengreen(String activityId, String sceneCode, String source) {
        ...
        //String args = "[" + params + "]";
        String requestData =
                "[{\"activityId\":\"" + activityId + "\",\"requestType\":\"RPC\",\"sceneCode\":\"" + sceneCode + "\","
                        + "\"source\":\"" + source + "\"}]";
    ...
    public static String listTaskopengreen(String sceneCode, String source) {
        ...
        //String args = "[" + params + "]";
        String requestData =
                "[{\"requestType\":\"RPC\",\"sceneCode\":\"" + sceneCode + "\",\"source\":\"" + source + "\"}]";
    ...
    public static String receiveTaskAwardopengreen(String source, String sceneCode, String taskType) {
        ...
        //String args = "[" + params + "]";
        String requestData = "[{\"ignoreLimit\":true,\"requestType\":\"RPC\",\"sceneCode\":\"" + sceneCode + "\"," +
    ...
    public static String exchangeTimesFromTaskopengreen(String activityId, String sceneCode, String source,
       ...
       /* JSONObject params = new JSONObject();
        ...
        String requestData =
                "[{\"activityId\":\"" + activityId + "\",\"requestType\":\"RPC\",\"sceneCode\":\"" + sceneCode + "\","
                        + "\"source\":\"" + source + "\",\"taskSceneCode\":\"" + taskSceneCode + "\",\"taskType\":\"" + taskType + "\"}]";
    ...
    public static String finishTask4Chouchoule(String taskType, String sceneCode) {
        ...
        String args = "[" + params + "]";*/
        String requestData =
                "[{\"outBizNo\":\"" + taskTypeRandom + "\",\"requestType\":\"RPC\",\"sceneCode\":\"" + sceneCode +
                        "\",\"source\":\"ADBASICLIB\",\"taskType\":\"" + taskType + "\"}]";
    ...
    public static String finishTaskopengreen(String taskType, String sceneCode) {
        ...
        String requestData =
                "[{\"outBizNo\":\"" + taskTypeRandom + "\",\"requestType\":\"RPC\",\"sceneCode\":\"" + sceneCode +
                        "\",\"source\":\"task_entry\",\"taskType\":\"" + taskType + "\"}]";
